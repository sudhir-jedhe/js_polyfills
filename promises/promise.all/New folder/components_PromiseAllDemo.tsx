...
const PromiseAllDemo: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <button
        onClick={addPromise}
        className="bg-blue-500 text-white px-4 py-2 rounded mb-4 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
      >
        Add Promise
      </button>
      ...
      <button
        ...
        className="bg-green-500 text-white px-4 py-2 rounded mt-4 disabled:bg-gray-400 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
      >
