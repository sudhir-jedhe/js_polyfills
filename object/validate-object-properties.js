...
💬  Note
These functions only check the presence of keys. You may also need to check if two objects have the same property keys and values to ensure that the objects match exactly.