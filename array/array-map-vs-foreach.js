...
As a closing note, I would like to remind you that the humble for loop can be more efficient in some cases, such as breaking out of a loop early. Always pick the right tool for the job, as ES6 has a method for almost every use case.