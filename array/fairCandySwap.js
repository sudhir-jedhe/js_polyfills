...
// aliceSizes is an array where aliceSizes[i] is the number of candies of the ith box of candy that Alice has.
// bobSizes is an array where bobSizes[j] is the number of candies of the jth box of candy that Bob has.
...
// Find an integer array answer where answer[0] is the number of candies in the box that Alice must exchange, and answer[1] is the number of candies in the box that Bob must exchange. If multiple answers exist, you can return any one of them.
// Example:
