...
## Table of Contents
- [Interview Algorithm Questions in Javascript() {...}](#interview-algorithm-questions-in-javascript-)
...
- [Arrow functions are cool in ES6. When should you NOT use arrow functions. Name three or more cases.](#arrow-functions-are-cool-in-es6-when-should-you-not-use-arrow-functions-name-three-or-more-cases)
  - [Event Handlers](#event-handlers)
- [What is the difference between an array literal vs a condensed array?](#what-is-the-difference-between-an-array-literal-vs-a-condensed-array)
  - [Array literal](#array-literal)
- [Condensed array](#condensed-array)
